---
layout: default
title: Flex Sensor Glove
---

<!-- Dark Top Banner with Title and Subtitle -->
<div class="projects-header">
  <h1 class="page-title">Flex Sensor Glove</h1>
  <p class="project-subtitle">Prosthetic Control & Sensor Integration</p>
</div>
...
<div class="project-detail-body">
  <div class="project-content-container">
    ...
    <div class="feature-row" style="border-top: 1px solid #e0e0e0;">
      <div class="feature-image">
        <img src="{{ '/assets/images/glove-assembled.jpg' | relative_url }}" alt="Flex Sensor Glove Assembly">
      </div>
    ...
    <div class="skills-section">
      ...
      <div class="skills-list">
        <span class="skill-pill">SOLDERING</span>
        <span class="skill-pill">ARDUINO PROGRAMMING</span>
        <span class="skill-pill">SENSOR INTEGRATION</span>
